...
.about-section .about-image .social-links
{
    margin-top: 20px;
    text-align: center;
}
.about-section .about-image .social-links a
{
    display: inline-block;
    height: 40px;
    width: 40px;
...
.about-section .about-image .social-links a i
{
    line-height: 40px;
}
.about-section .about-image .social-links a::after
{
    border-radius: 50%;
}
.about-section .about-image .social-links a:hover
{
    color: var(--skin-color);
}
